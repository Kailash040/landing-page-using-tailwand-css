...
const Home = () => {
  return (
    <>
      <div className="flex justify-center bg-blue-500 text-gray-50 font-semibold gap-[12px] py-[9px]  text-xs items-center sm:text-sm ">
        {" "}
        <img src={Vector} className="w-[24px] h-[24px]" alt="" />
        <p className="discount_para ">30% off storewide — Limited time! </p>{" "}
        <p className="border-b-2 border-gray-50 ">Shop Now </p>
      </div>
      <div className="navbar flex justify-evenly py-4 items-center">
        ...
        <div className=" hidden center_nav_section  list-none sm:flex gap-10 text-[14px] font-sans  ">
          <li>
            <a href="#">Home</a>
          </li>
          <li>
